...
public class MapleMapFactory {
    ...
    private static final Boolean MapleStorydMapAddMob = Boolean.valueOf(Boolean.parseBoolean(ServerProperties.getProperty("CongMS.dMapAddMob")));
    private static final int MapleStorydMapAddMobNum = Integer.parseInt(ServerProperties.getProperty("CongMS.dMapAddMobNum"));
    private static String str = ServerProperties.getProperty("CongMS.dMapAddMobMapList");
