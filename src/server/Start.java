...
public class Start {
    ...
    public static final void main(final String[] args) {
        if (Start.是否控制台启动) {
            ...
            if (授权 == 1) {
                ...
                System.out.println("[泡点地图：910000000(自由市场)]");
                福利泡点(2);
                自动存档(3);
                在线时间(1);
                System.out.println("◇ -> 启动服务端内存回收线程");
                ...
                OnlyID.getInstance();
                System.out.println("\r\n[开始加载] 自定义游戏配置信息");
                if (Boolean.parseBoolean(ServerProperties.getProperty("CongMS.dMapAddMob"))) {
                    System.out.println("[正在加载]自定义部分地图怪物刷新倍数: 已开启");
                    System.out.println("[正在加载]自定义部分地图怪物刷新倍数值为" + Integer.parseInt(ServerProperties.getProperty("CongMS.dMapAddMobNum")) + "倍");
                }
    ...
    public static int 进行授权校验() {
        int ret = 0;
        String[] macs = {
            "708f005710942f794835215f40974d0902414fe8",
            "63dd380b0a343688288ddfeecbe6d06ad17810df",
            "6993556b97ce679d83a66cb36db5593e97c39a0e",
            "1b48a9487cb41085ec9384e50d2589504709569b",
            "acb9d23fbac9073d74a84e0c49efc6ed8fa48a91",
            "8dffcdcdbf80555523fb8c0877b36a9af5fb3336",
            "abb8bb439105565ce3e58db8af5d089f7e012578",
            "091e052935987d66ca704ee2aaca494f6646149a",
            "2b5f67b4f326afe460a06fc9e933ac594eacf2b6",
            "6a61f9accabe50ff3eab9960b51149b1d7af1c7c"};

        String mac = MacAddressTool.getMacAddress(false);
        String num = returnSerialNumber();
        String localMac = LoginCrypto.hexSha1("liu" + num + "nian" + mac + "yin" + mac + "xiang") + "LnyxMS";
