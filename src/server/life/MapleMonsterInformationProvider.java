    ...
    private void retrieveGlobal() {
        ...
        try (final Connection con = (Connection) DBConPool.getInstance().getDataSource().getConnection()) {
            ...
            try {
                ...
                FileoutputUtil.outError("logs/数据库异常.txt", (Throwable) ignore);
            }
        } finally {
            try {
                if (ps != null) {
                ...
                FileoutputUtil.outError("logs/数据库异常.txt", (Throwable) ignore2);
            }
        }
    }
    ...
    public List<Integer> getMobByItem(final int itemId) {
        ...
        try {
            ...
            try {
                ...
                FileoutputUtil.outputFileError("logs/数据库异常.txt", (Throwable) ignore);
                return null;
            }
        } catch (SQLException e) {
            e.printStackTrace();
            ...
            try {
                ...
                FileoutputUtil.outputFileError("logs/数据库异常.txt", (Throwable) ignore2);
                return null;
            }
        }
        return mobs;
