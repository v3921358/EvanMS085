...
public class ChannelServer implements Serializable {
    ...
    private static String 初始ip = ServerProperties.getProperty("CongMS.CustomIP");
    ...
    public final void setup() {
        ...
        try {
            ...
            this.port = (short) ((ServerProperties.getProperty("CongMS.channel.port", DEFAULT_PORT) + channel) - 1);
        } catch (Exception e) {
