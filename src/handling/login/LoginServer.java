...
public class LoginServer {
    ...
    private static int 角色数量, userLimit, usersOn = 0, 等级上限, 泡点地图, 抵用卷数量, 点卷数量, 豆豆数量, 等级经验倍率;
    ...
    public static final void setup() {
        ...
        泡点地图 = Integer.parseInt(ServerProperties.getProperty("CongMS.泡点地图"));
        点卷数量 = Integer.parseInt(ServerProperties.getProperty("CongMS.点卷数量"));
        抵用卷数量 = Integer.parseInt(ServerProperties.getProperty("CongMS.抵用卷数量"));
        豆豆数量 = Integer.parseInt(ServerProperties.getProperty("CongMS.豆豆数量"));
        等级经验倍率 = Integer.parseInt(ServerProperties.getProperty("CongMS.等级经验倍率"));
        角色数量 = Integer.parseInt(ServerProperties.getProperty("CongMS.角色数量"));
        等级上限 = Integer.parseInt(ServerProperties.getProperty("CongMS.等级上限"));
    ...
    public static final int 点卷数量() {
        return 点卷数量;
    }

    public static final int 豆豆数量() {
        return 豆豆数量;
    }

    public static final int 抵用卷数量() {
        return 抵用卷数量;
    }

    public static final int 等级经验倍率() {
        return 等级经验倍率;
    }
