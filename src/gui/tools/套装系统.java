...
public class 套装系统 extends javax.swing.JFrame {
    ...
    private void 刷新套装1最少触发件数() {
        int 显示 = CongMS.ConfigValuesMap.get("套装1最少触发件数");
        套装1触发件数.setText("" + 显示 + "");
    }

    private void 刷新套装1附加百分比伤害() {
        int 显示 = CongMS.ConfigValuesMap.get("套装1附加百分比伤害");
        套装1伤害增加百分比.setText("" + 显示 + "");
    }

    private void 刷新套装1多穿一件附加() {
        int 显示 = CongMS.ConfigValuesMap.get("套装1多穿一件附加");
        套装1多穿一件增加.setText("" + 显示 + "");
    }

    private void 刷新套装2最少触发件数() {
        int 显示 = CongMS.ConfigValuesMap.get("套装2最少触发件数");
        套装2触发件数.setText("" + 显示 + "");
    }

    private void 刷新套装2附加百分比伤害() {
        int 显示 = CongMS.ConfigValuesMap.get("套装2附加百分比伤害");
        套装2伤害增加百分比.setText("" + 显示 + "");
    }

    private void 刷新套装2多穿一件附加() {
        int 显示 = CongMS.ConfigValuesMap.get("套装2多穿一件附加");
        套装2多穿一件增加.setText("" + 显示 + "");
    }

    private void 刷新套装3最少触发件数() {
        int 显示 = CongMS.ConfigValuesMap.get("套装3最少触发件数");
        套装3触发件数.setText("" + 显示 + "");
    }

    private void 刷新套装3附加百分比伤害() {
        int 显示 = CongMS.ConfigValuesMap.get("套装3附加百分比伤害");
        套装3伤害增加百分比.setText("" + 显示 + "");
    }

    private void 刷新套装3多穿一件附加() {
        int 显示 = CongMS.ConfigValuesMap.get("套装3多穿一件附加");
        套装3多穿一件增加.setText("" + 显示 + "");
    }

    private void 刷新套装4最少触发件数() {
        int 显示 = CongMS.ConfigValuesMap.get("套装4最少触发件数");
        套装4触发件数.setText("" + 显示 + "");
    }

    private void 刷新套装4附加百分比伤害() {
        int 显示 = CongMS.ConfigValuesMap.get("套装4附加百分比伤害");
        套装4伤害增加百分比.setText("" + 显示 + "");
    }

    private void 刷新套装4多穿一件附加() {
        int 显示 = CongMS.ConfigValuesMap.get("套装4多穿一件附加");
        套装4多穿一件增加.setText("" + 显示 + "");
    }

    private void 刷新套装5最少触发件数() {
        int 显示 = CongMS.ConfigValuesMap.get("套装5最少触发件数");
        套装5触发件数.setText("" + 显示 + "");
    }

    private void 刷新套装5附加百分比伤害() {
        int 显示 = CongMS.ConfigValuesMap.get("套装5附加百分比伤害");
        套装5伤害增加百分比.setText("" + 显示 + "");
    }

    private void 刷新套装5多穿一件附加() {
        int 显示 = CongMS.ConfigValuesMap.get("套装5多穿一件附加");
        套装5多穿一件增加.setText("" + 显示 + "");
    }

    private void 刷新套装6最少触发件数() {
        int 显示 = CongMS.ConfigValuesMap.get("套装6最少触发件数");
        套装6触发件数.setText("" + 显示 + "");
    }

    private void 刷新套装6附加百分比伤害() {
        int 显示 = CongMS.ConfigValuesMap.get("套装6附加百分比伤害");
        套装6伤害增加百分比.setText("" + 显示 + "");
    }

    private void 刷新套装6多穿一件附加() {
        int 显示 = CongMS.ConfigValuesMap.get("套装6多穿一件附加");
    ...
    private void 刷新套装叠加开关() {
        String 显示 = "";
        int S = CongMS.ConfigValuesMap.get("套装叠加开关");
        if (S <= 0) {
            显示 = "套装共存:开启";
        } else {
            显示 = "套装共存:关闭";
    ...
    private void 刷新套装系统开关() {
        String 显示 = "";
        int S = CongMS.ConfigValuesMap.get("套装系统开关");
        if (S <= 0) {
            显示 = "套装系统:开启";
        } else {
            显示 = "套装系统:关闭";
