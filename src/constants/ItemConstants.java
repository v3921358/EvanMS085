...
import static constants.GameConstants.isChaosScroll;
...
public class ItemConstants {
    ...
    public static int getChaosNumber(int itemId) {//你什么卷 就加 0-到多少  你可以随意定义  如果没有的卷轴 就是0-5 刚才你哪个就没有 这些地方都没有定义他 所有0-5 走最后一个
        switch (itemId) {
